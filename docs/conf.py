...
# builds the documentation pages of the Mocking Requests Futures
# project.
...
def get_templated_vars():
    return type(
        ...
        (),
        dict(
            project_slug='pytest-requests-futures',
            package_name='pytest_requests_futures',
            author_name='Konstantinos Lampridis',
            year='2022',
            version='0.0.1',
            github_username='boromir674',
            repo_name='pytest-requests-futures',
        ),
    )
